...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <div class="target">こんばんは</div>
        <div id="image-container">
          <img class="image" src="abc.jpg" alt="Image 1">
          <img class="image" src="before.png" alt="Image 2">
        </div>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <ul>
            	 ...
            	 <script src="https://maps.googleapis.com/maps/api/js?language=ja&region=JP&key=AIzaSyCyiaFrJ1Skj23wpqS95Yde6WuLnQ_874E&callback=initMap" async defer></script>
